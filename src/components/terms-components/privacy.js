    ...
    <div>
      ...
      >
        ...
        <p>
          ...
          facilitate our marketing and advertising activities, for service
          recovery purposes, or to prevent, detect, mitigate, and investigate
          fraudulent or illegal activities related to our Services. We do not
        ...
        <p>
          <strong>4. Security Precautions</strong>
        </p>
        <p>
        ...
        <p>
          <strong>5. Choice/Opt-Out</strong>
        </p>
        <p>
        ...
        <p>Mr. Prashanth M S</p>
        <p>Migobucks Technologies private Limited</p>
        <p>NO.14, Hosabasavanapura,</p>
        <p>Krishnarajapura,</p>
        <p>Bengaluru &ndash; 5560016, Karnataka, India</p>
        <p>Phone: 9037243199, 70900 70200</p>
        <p>Email: prashath@migobucks.com</p>
